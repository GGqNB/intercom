<template>
  <s-page>
    ...
    <div class="home_wrapper">
      <video ref="user1Video" autoplay muted playsinline></video>
      <video ref="user2Video" autoplay playsinline></video>
      <h3>Перейдите в сайдабар</h3>
      <div>
        <label>Remote Client ID:</label>
        <input type="text" v-model="remoteClientID" placeholder="Enter remote client ID">
      </div>
      <div class="step">
        <p><strong>Step 1:</strong> User 1, click "Create offer" to generate SDP offer.</p>
        <button @click="createOffer">Create Offer</button>
      </div>

      <div class="step">
        <p><strong>Step 2:</strong> User 2, paste SDP offer generated by user 1. Press create answer to generate SDP answer</p>
        <button @click="createAnswer">Create answer</button>
      </div>
       <div class="step">
        <p><strong>Step 3:</strong> User 1, press Add answer</p>
