...
<s-dialog :title='titleDialog'>
    <div class="home_wrapper">
        <q-form ref="form">
          ...
          NotEmpty(),
            ...
            <div class="mt-base-25 ">
                <s-input
                    v-model="formData.flat_first"
                    label="Введите первую квартиру для этого входа"
                    clearable
                    type="number"
                    debounce="600"
                    class="col-12"
 ...
 <div class="mt-base-25 ">
                <s-input
                    v-model="formData.flat_last"
                    label="Введите последнюю квартиру для этого входа"
                    clearable
                    type="number"
                    debounce="600"
                    class="col-12"
