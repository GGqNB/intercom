...
<s-page>
    ...
    <div class="">
        ...
        <dialog-entry v-model="visibleDialog" :create-service="createService" />
    </div>
...
import FiltersEntry from '../components/Filters.vue'
import DialogEntry from '../components/DialogEntry.vue';
